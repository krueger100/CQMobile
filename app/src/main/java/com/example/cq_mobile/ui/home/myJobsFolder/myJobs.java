...
public class myJobs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myJobAdapter myJobAdapter = new myJobAdapter(this);
        viewPager.setAdapter(myJobAdapter);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (customView != null) {
                    ...
                    customView.setBackground(ContextCompat.getDrawable(myJobs.this, R.drawable.selected_tab_bg));
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                ...
                if (customView != null) {
                    ...
                    TextView tabText = customView.findViewById(R.id.tabText);
                    ImageView tabIcon = customView.findViewById(R.id.tabIcon);
                    tabText.setTextColor(ContextCompat.getColor(myJobs.this, R.color.tab_text_color));
                    tabIcon.setColorFilter(ContextCompat.getColor(myJobs.this, R.color.tab_icon_color));
                }
            }
