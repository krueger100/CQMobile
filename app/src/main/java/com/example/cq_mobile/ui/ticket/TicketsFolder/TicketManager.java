...
public class TicketManager {
    ...
    public void loadTickets(int page, int pageSize, final AllTicketsCallback callback) {
        ...
        Call<TicketAPIResponse> call = ticketApi.getTickets(page, pageSize, accessToken, "Bearer " + accessToken);

        call.enqueue(new Callback<TicketAPIResponse>() {
            @Override
...
curl -X GET "https://aws.customquoter.co.uk/api/m/tickets" \
-H "Authorization: Bearer 5623|qi1c6mlU56torLCTinGwoaeyqqm9Ocxn0nTZX63W" \
-H "x-api-key: BLSNDC1Blc29jhd4jJ898FPrIS1s6YE2" \
-H "Accept: application/json" \
-H "Content-Type: application/json" \
