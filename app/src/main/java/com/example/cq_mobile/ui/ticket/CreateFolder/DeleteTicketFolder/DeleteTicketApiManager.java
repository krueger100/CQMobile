package com.example.cq_mobile.ui.ticket.CreateFolder.DeleteTicketFolder;
...
public class DeleteTicketApiManager {
    ...
    public static String deleteTicket(String ticketId) {
        ...
        try {
            ...
            String urlString = BASE_URL + ticketId;
            Log.d(TAG, "Connecting to URL: " + urlString); // Log URL
...
/*
curl -v -L -X DELETE "https://aws.customquoter.co.uk/api/m/tickets/174" \
