...
public class FilesActivity extends AppCompatActivity {
    TextView files_back,files_back2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        files_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FilesActivity.this, NewBuild.class);
                intent.putExtra("job_id", jobId);
                startActivity(intent);
            }
        });
        files_back2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FilesActivity.this, NewBuild.class);
                intent.putExtra("job_id", jobId);
